...
artifact_folder = os.path.normpath(os.path.join(script_folder, '../..', 'artifacts'))
...
def predict_next_month( 
    ...
    df_historique_brut = pd.read_csv(os.path.join(target_folder, 'conso_mensuelle_brut.csv'))
    
    # Récuppération de l'artifact du modèle
    artifact = load_artifact_local()
